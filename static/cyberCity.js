...
Star.prototype.draw = function() {
    ...
    ctx.fillText(characters.charAt(Math.floor(Math.random() * charactersLength)), this.x, this.y);
    ctx.closePath();
...
function setCanvasSize() {
    WIDTH = document.getElementById('TopBar').clientWidth;
